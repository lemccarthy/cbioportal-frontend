...
> {
  ...
  protected generateColumns(): {
    ...
    columns[ExpressionEnrichmentTableColumnType.MEAN_IN_UNALTERED] = {
      ...
      tooltip: (
        <span>
          Mean log2 expression of the listed gene in samples that do not have
          alterations in the query gene(s).
        </span>
      ),
    ...
    columns[
      ...
      tooltip: (
        <span>
          Standard deviation of log2 expression of the listed gene in samples
          that have alterations in the query gene(s).
        </span>
      ),
    ...
    columns[
      ...
      tooltip: (
        <span>
          Standard deviation of log2 expression of the listed gene in samples
          that do not have alterations in the query gene(s).
        </span>
      ),
    ...
    columns[ExpressionEnrichmentTableColumnType.LOG_RATIO] = {
      ...
      tooltip: (
        <span>
          Log2 of ratio of (unlogged) mean in altered to (unlogged) mean in
          unaltered
        </span>
      ),
