  ...
  @autobind private onInputClick(event: React.MouseEvent<HTMLInputElement>) {
    switch ((event.target as HTMLInputElement).value) {
      case EVENT_KEY.hidePutativePassengers:
        this.props.store.driverAnnotationSettings.ignoreUnknown = !this.props
          .store.driverAnnotationSettings.ignoreUnknown;
        break;
          ...
          <div className="checkbox">
            <label>
              <input
                ...
                checked={
                  !this.props.store.driverAnnotationSettings.ignoreUnknown
                }
                onClick={this.onInputClick}
