              ...
              <label>
                ...
                {this.props.state.annotateDriversOncoKbError && (
                  <ErrorIcon
                    ...
                    tooltip={
                      <span>
                        Error loading OncoKb data. Please refresh the page or
                        try again later.
                      </span>
                    }
                  />
                ...
                <label>
                  ...
                  {this.props.state.annotateDriversHotspotsError && (
                    <ErrorIcon
                      ...
                      tooltip={
                        <span>
                          Error loading Hotspots data. Please refresh the page
                          or try again later.
                        </span>
                      }
                    />
                  ...
                  <DefaultTooltip
                    overlay={
                      <div style={{ maxWidth: "400px" }}>
                        ...
                        samples of various cancer types using methodology based
                        in part on{" "}
                        <a
