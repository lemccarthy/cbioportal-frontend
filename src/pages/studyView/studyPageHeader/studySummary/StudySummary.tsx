...
import { IAnalyticsResponse } from "pages/studyView/queryStudyAnalytics";
...
interface IStudySummaryProps {
    ...
    studyAnalytics?: IAnalyticsResponse;
}

const renderBadge = (analytics: IAnalyticsResponse) => {
    return (
        <DefaultTooltip
            trigger={["hover"]}
            placement={"top"}
...
export default class StudySummary extends React.Component<IStudySummaryProps, {}> {
    ...
    get descriptionRemainingLines() {
        if (this.props.studies.length === 1) {
            ...
            return map(this.props.studies, study => {
                return (
                    <li>
