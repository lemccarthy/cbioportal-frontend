...
import { makeGenePanelPopupLink } from "shared/components/oncoprint/TooltipUtils";
...
export class CNAGenesTable extends React.Component<ICNAGenesTablePros, {}> {
    ...
    @observable private modalPanelName = "";
    @observable private modalPanelGenes: GenePanelToGene[] = [];
    ...
    toggleModal = (panelName: string, genes: GenePanelToGene[]) => {
        ...
        this.modalPanelName = panelName;
        this.modalPanelGenes = genes;
    }
    ...
    public render() {
        return (
            <div>
                ...
                <GenePanelModal
                    show={this.modalOpen}
                    genes={this.modalPanelGenes}
                    panelName={this.modalPanelName}
